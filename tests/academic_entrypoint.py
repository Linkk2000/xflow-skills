...
def main() -> int:
    ...
    for file_name, refs in {
        ...
        "templates/cursorrules.academic": (
            ...
            "Do not require emoji status markers",
            "`PASS`, `WARN`, and `FAIL`",
        ...
        "references/academic-workflow.md": (
            ...
            "command marked `installed`",
            "marked `missing`",
            "medical machine learning",
            "Do not choose `/paper-lookup`, `/research-lookup`,",
            "DEVCTL_CLAUDE_TIMEOUT_SECONDS",
            "--disallowedTools Bash,Edit,Write,Read",
            "Avoid requiring emoji status markers",
            "`PASS`, `WARN`, and `FAIL`",
