...
def main() -> int:
    ...
    for file_name, refs in {
        "SKILL.md": (
            ...
            "reviewer defaults to Git `user.name` and `user.email`",
        ...
        "templates/codex-agents.academic.md": (
            ...
            "devctl claude setup plan --skills",
            ...
            "devctl approval prepare --issue <id> --action <action> --file <artifact>",
            "devctl check current-task --issue <id>",
            "XFLOW_PLATFORM belongs in the paper repository",
            "Gitee Issue/PR commands use `GITEE_TOKEN`",
        ),
        ...
        "references/academic-workflow.md": (
            ...
            "GITHUB_TOKEN",
            "GITEE_TOKEN",
            "Global token files are token-only",
            ...
            "Approved: yes",
            "project-local",
            "Claude skill delegation is unavailable",
        ...
        "references/academic-schema-contract.md": (
            ...
            "devctl claude setup inspect",
            "devctl claude setup plan",
            "devctl claude setup apply",
            ".xflow/local/claude-setup-plan.md",
            "Approved: no",
            "Approved: yes",
            "project-local",
            "DEVCTL_CLAUDE_TIMEOUT_SECONDS",
    ...
    for file_name, refs in {
        ...
        "templates/cursorrules.academic": (
            ...
            "Do not assume Gitee Issue/PR creation is available in academic Python mode",
        ),
    }.items():
        for ref in refs:
