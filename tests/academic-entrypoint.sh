...
require_ref "templates/codex-agents.academic.md" "devctl claude setup inspect"
require_ref "templates/codex-agents.academic.md" "devctl claude setup plan --skills"
require_ref "templates/codex-agents.academic.md" "devctl claude setup apply --plan .xflow/local/claude-setup-plan.md"
require_ref "templates/codex-agents.academic.md" "Approved: yes"
require_ref "templates/codex-agents.academic.md" "project-local"
...
require_ref "templates/cursorrules.academic" "devctl claude setup inspect"
require_ref "templates/cursorrules.academic" "devctl claude setup plan --skills"
require_ref "templates/cursorrules.academic" "devctl claude setup apply --plan .xflow/local/claude-setup-plan.md"
require_ref "templates/cursorrules.academic" "Approved: yes"
require_ref "templates/cursorrules.academic" "project-local"
...
require_ref "references/academic-workflow.md" "devctl claude setup inspect"
require_ref "references/academic-workflow.md" "devctl claude setup plan --skills"
require_ref "references/academic-workflow.md" "devctl claude setup apply --plan .xflow/local/claude-setup-plan.md"
require_ref "references/academic-workflow.md" "Approved: no"
require_ref "references/academic-workflow.md" "Approved: yes"
require_ref "references/academic-workflow.md" "project-local"
require_ref "references/academic-workflow.md" "Claude skill delegation is unavailable"
...
require_ref "references/academic-schema-contract.md" "devctl claude setup inspect"
require_ref "references/academic-schema-contract.md" "devctl claude setup plan"
require_ref "references/academic-schema-contract.md" "devctl claude setup apply"
require_ref "references/academic-schema-contract.md" ".xflow/local/claude-setup-plan.md"
require_ref "references/academic-schema-contract.md" "Approved: no"
require_ref "references/academic-schema-contract.md" "Approved: yes"
require_ref "references/academic-schema-contract.md" "project-local"
