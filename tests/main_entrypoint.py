...
def main() -> None:
    ...
    require("SKILL.md", "do not rewrite commits solely to strip them")
    ...
    require("SKILL.md", "Approved File Absolute")
    require("SKILL.md", "Local Review Absolute")
    ...
    require("SKILL.md", "remote-write receipts")
    ...
    require("references/ops-lessons.md", "Push Receipt Loop")
    ...
    require("templates/xflow-local-ignored-vendor-init-prompt.md", "按其中记录的 source/ref/mode/path 执行 restore")
    require("templates/xflow-local-ignored-vendor-init-prompt.md", '"version": 1')
    require("templates/xflow-local-ignored-vendor-init-prompt.md", ".xflow/config.env.example")
    require("templates/xflow-local-ignored-vendor-init-prompt.md", "只有 clean 且当前分支/ref 一致时")
    require("templates/xflow-local-ignored-vendor-init-prompt.md", "不得 reset、clean、stash、覆盖或自动切换版本")
    require("templates/xflow-local-ignored-vendor-init-prompt.md", "POSIX 必跑：`./devctl help`、`./devctl preflight`")
    require("templates/xflow-local-ignored-vendor-init-prompt.md", "当前版本提供时再运行同平台的 `doctor` 与 `check encoding`")
    require("templates/xflow-local-ignored-vendor-init-prompt.md", "不得创建或切换业务仓库分支")
    require("templates/xflow-local-ignored-vendor-init-prompt.md", "首次初始化默认 `issueWorkspace.mode: tracked`")
    require("templates/xflow-local-ignored-vendor-init-prompt.md", "不得静默改回 tracked")
    require("templates/xflow-local-ignored-vendor-init-prompt.md", "使用 `git check-ignore -v`")
    require("templates/xflow-local-ignored-vendor-init-prompt.md", "git check-ignore -v --no-index .xflow/issues/issue-probe/probe.md")
    require("templates/xflow-local-ignored-vendor-init-prompt.md", "不创建探针文件")
    require("templates/xflow-local-ignored-vendor-init-prompt.md", "初始化完成后停止")
    ...
    require("templates/codex-agents.main.md", "do not rewrite commits solely to strip them")
    ...
    require("references/human-gates.md", "absolute filesystem paths")
    require("references/human-gates.md", "Local Review Absolute")
    require("references/human-gates.md", "Approved File Absolute")
