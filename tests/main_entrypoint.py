...
def main() -> None:
    ...
    require("SKILL.md", "--upload-attachments github")
    ...
    require("references/attachment-policy.md", "Images are attachments")
    ...
    require("references/attachment-policy.md", "Unattended GitHub attachment issue")
    require("references/devctl-contract.md", "AI Call Recipes")
    require("references/devctl-contract.md", "--attach-file accepts any file")
    require("references/devctl-contract.md", "GITHUB_TOKEN is required for GitHub uploads")
    ...
    require("references/xflow-map.md", "--backend github")
