...
def main() -> None:
    ...
    require("SKILL.md", "AI must not use `--force`, `--no-local-review`, direct provider APIs")
    require("SKILL.md", "继续")
    ...
    require("SKILL.md", "`type(scope): 中文摘要`")
    require("SKILL.md", "`关联 issue: #<id>`")
    ...
    require("AGENTS.md", "`type(scope): 中文摘要`")
    require("AGENTS.md", "`关联 issue: #<id>`")
    ...
    require("templates/codex-agents.main.md", "`type(scope): 中文摘要`")
    require("templates/codex-agents.main.md", "`关联 issue: #<id>`")
    ...
    require("templates/cursorrules.main", "`type(scope): 中文摘要`")
    require("templates/cursorrules.main", "`关联 issue: #<id>`")
    ...
    require("references/xflow-map.md", "type(scope): 中文摘要")
    require("references/xflow-map.md", "关联 issue: #<id>")
    ...
    require("references/devctl-contract.md", "关联 issue: #<number>")
    ...
    require("references/source-resolution.md", "Project submodules are the runtime source of truth")
    require("references/source-resolution.md", ".xflow/ops/devctl")
    require("references/source-resolution.md", ".xflow/ops/workflow")
    require("references/bootstrap-policy.md", "Submodule mode is the default")
